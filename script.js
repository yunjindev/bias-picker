...
const idolLists = document.querySelectorAll(".idol-list");
const idolListsLi = document.querySelectorAll(".idol-list li");
let selectedIdol = "";



// Button to show idols
testBtn.addEventListener("click", () => {
    idolLists.forEach(idolList => {
        idolList.style.display = "block";
    });
});

// Button to hide idols
removeBtn.addEventListener("click", () => {
    idolLists.forEach(idolList => {
        idolList.style.display = "none";
    });
});
